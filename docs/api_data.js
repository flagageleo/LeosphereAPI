define({ "api": [
  ...
  },
  {
    ...
    "group": "C__Users_JUSCH_Desktop_api110_API120_apidoc_main_js",
    "groupTitle": "C__Users_JUSCH_Desktop_api110_API120_apidoc_main_js",
    "name": ""
  },
  {
    "type": "GET",
  ...
  },
  {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "description": "<p>Start executing time in ISO8601 format (example 2018-02-05T02:00:00) expressed with system timezone</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
    ...
    "filename": "./Doc3.4.0_1.1.0_rev001 - Copie.js",
    "groupTitle": "Configuration"
  },
  {
    "type": "GET",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "time_zone",
            "description": "<p>Lidar timezone</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "start_time",
            "description": "<p>Acquisition starting time in ISO8601 format (example 2018-02-05T02:00:00) expressed in system timezone. Only to be used for start_acq command. Software will wait for this time before acquisitin. The scanner will be positionned before it.</p>"
          },
          {
            "group": "Parameter",
            "type": "<hr>",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "start_time",
            "description": "<p>Acquisition starting time in ISO8601 format (example 2018-02-05T02:00:00) expressed in system timezone. Only to be used for start_acq command. Software will wait for this time before starting acquisition. The scanner will be positionned before it.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "timestamp",
            "description": "<p>Timestamp at the end of each ray measurement following ISO8601 format ( example 2018-05-11T02:12:35.123) expressed in system timezone</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_time",
            "description": "<p>Start time of the interval following ISO8601 format ( example 2018-05-11T02:12:35) expressed in system timezone.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "end_time",
            "description": "<p>End time of the interval following ISO8601 format ( example 2018-05-11T02:12:35)expressed in system timezone.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "timestamp",
            "description": "<p>Timestamp at the end of each ray measurement following ISO8601 format ( example 2018-05-11T02:12:35) expressed in system timezone.</p>"
          },
          {
            "group": "Success 200",
            "type": "Number[]",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_time",
            "description": "<p>start time expressed in system timezone of the interval following ISO8601 format ( example 2018-05-11T02:12:35)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "end_time",
            "description": "<p>end time expressed in system timezone of the interval following ISO8601 format ( example 2018-05-11T02:12:35)</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "min_timestamp",
            "description": "<p>Timestamp of the first data in database  following ISO8601 format ( example 2018-05-11T02:12:35.000) expressed in system timezone.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "max_timestamp",
            "description": "<p>Timestamp of the last data in database  following ISO8601 format ( example 2018-05-11T02:12:35.000) expressed in system timezone.</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_time",
            "description": "<p>Start time of interval to get Lidar activities history following ISO8601 format ( example 2018-05-11T02:12:35) expressed in system timezone.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "end_time",
            "description": "<p>Final time of interval to get Lidar activities history following ISO8601 format ( example 2018-05-11T02:12:35) epressed n system timezone.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_time",
            "description": "<p>Start time of interval to get Lidar environmental data history following ISO8601 format ( example 2018-05-11T02:12:35Z) expressed in system timezone.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "end_time",
            "description": "<p>Final time of interval to get Lidar environmental data following ISO8601 format ( example 2018-05-11T02:12:35Z)  expressed in system timezone.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_time",
            "description": "<p>start time expressed with system timezone of the interval following ISO8601 format ( example 2018-05-11T02:12:35) expressed in system timezone</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "end_time",
            "description": "<p>end time expressed with system timezone of the interval following ISO8601 format ( example 2018-05-11T02:12:35) expressed in system timezone</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_time",
            "description": "<p>start time expressed with system timezone of the interval following ISO8601 format ( example 2018-05-11T02:12:35)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "end_time",
            "description": "<p>end time expressed with system timezone of the interval following ISO8601 format ( example 2018-05-11T02:12:35)</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "start_time",
            "description": "<p>Start time of interval to get devices status history following ISO8601 format ( example 2018-05-11T02:12:35) expressed in system timezone</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "end_time",
            "description": "<p>Final time of interval to get devices status history following ISO8601 format ( example 2018-05-11T02:12:35)</p>"
          }
        ]
      }
    },
